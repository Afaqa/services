...
if ! wp core is-installed ; then
    wp core install --url=http://192.168.99.193:5050 --title="itressa's k8s services" --admin_user="itressa" --admin_password="itressa" --admin_email="itressa@email.com" --skip-email
